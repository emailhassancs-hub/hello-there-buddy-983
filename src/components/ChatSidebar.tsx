...
export const ChatSidebar = ({
  ...
  if (isCollapsed) {
    return (
      <div className="w-12 h-full bg-transparent border-r border-white/10 flex flex-col items-center py-4 gap-4">
        <Button
          variant="ghost"
          size="icon"
  ...
  return (
    <div className="w-[14%] h-full bg-transparent border-r border-white/10 flex flex-col shadow-soft">
