  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-[1600px] mx-auto flex flex-col lg:flex-row items-center gap-12">
        {/* LEFT COLUMN */}
        <div className="flex-1 lg:max-w-[55%] lg:pr-12 rounded-2xl p-6 lg:p-8" style={{ background: "rgba(13,13,16,0.35)", backdropFilter: "blur(8px)", WebkitBackdropFilter: "blur(8px)", border: "1px solid rgba(61,61,77,0.25)" }}>
