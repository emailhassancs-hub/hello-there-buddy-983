...
const navItems = [
  ...
  { icon: ZoomIn, label: "Upscale", tooltip: "Upscale Image", path: "/upscale" },
  { icon: GitBranch, label: "Workflow", tooltip: "Workflows", path: "/workflow" },
  { icon: Wrench, label: "Tools", tooltip: "All Tools", path: "/tools" },
  { icon: Users, label: "Community", tooltip: "Community", path: "/community" },
];

const bottomItems = [
  { icon: Sparkles, label: "Assist", tooltip: "AI Assist", action: "assist" as const },
  { icon: Settings, label: "Settings", tooltip: "Settings", action: "settings" as const },
];
