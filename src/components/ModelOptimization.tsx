...
interface ModelOptimizationProps {
  ...
  onAddDirectMessage?: (role: "user" | "assistant", text: string, formType?: string, formData?: any) => void
}
...
Be friendly and instructive. Use short explanations and examples where needed.`
    ...
    try {
      ...
      const API_URL = "http://35.209.183.202:8000";
      ...
      onAddDirectMessage?.("assistant", "", "model-selection", {
        models: models
      });
    } catch (error) {
